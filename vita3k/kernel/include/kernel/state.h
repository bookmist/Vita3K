...
struct KernelState {
    ...
    ThreadStatePtr create_thread(MemState &mem, const char *name, Ptr<const void> entry_point, int init_priority, int stack_size, int cpu_affinity_mask, const SceKernelThreadOptParam *option);

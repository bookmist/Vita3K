...
enum SceKernelMemBlockType {
    ...
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_MAIN_R = 0x0320D040,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_MAIN_RX = 0x0320D050,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_MAIN_RW = 0x0320D060,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_SHARED_R = 0x0390D040,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_SHARED_RX = 0x0390D050,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_SHARED_RW = 0x0390D060,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_CDIALOG_R = 0x03A0D040,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_CDIALOG_RX = 0x03A0D050,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_CDIALOG_RW = 0x03A0D060,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_TOOL_R = 0x03F0D040,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_TOOL_RX = 0x03F0D050,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_SHARED_TOOL_RW = 0x03F0D060,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_IO_SO_R = 0x0B100240,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_IO_SO_RW = 0x0B100260,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_IO_DEVICE_R = 0x0B100840,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_IO_DEVICE_RW = 0x0B100860,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_TOOL_R = 0x08F0D040,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_TOOL_RX = 0x08F0D050,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_TOOL_RW = 0x08F0D060,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_TOOL_UNK_RW = 0x08F0D006,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_MAIN_RX = 0x0C20D050,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_MAIN_PHYCONT_R = 0x0C80D040,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_MAIN_PHYCONT_NC_R = 0x0D808040,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_MAIN_TOOL_RX = 0x0CF0D050,
    SCE_KERNEL_MEMBLOCK_TYPE_USER_CDIALOG_RX = 0x0E20D050,

    SCE_KERNEL_MEMBLOCK_TYPE_USER_UNK_0720D006_RW = 0x0720D006, /* SCE_KERNEL_ERROR_ILLEGAL_PARTITION_INDEX */

    /*
     * The kernel memtypes that only the Kernel can allocate
     */

    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_SO_RW = 0x10200206,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_DEVICE_RW = 0x10200806,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_L1WBWA_RW = 0x10204006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_NC_R = 0x10208004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_NC_RW = 0x10208006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_R = 0x1020D004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_RX = 0x1020D005,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_RW = 0x1020D006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_PHYCONT_R = 0x1080D004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_PHYCONT_RW = 0x1080D006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_PHYCONT_NC_R = 0x30808004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_PHYCONT_NC_RW = 0x30808006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_GAME_RW = 0x1050D006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_CDIALOG_R = 0x10A0D004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_CDIALOG_RW = 0x10A0D006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_UMAIN_NC_RW = 0x10C08006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_ROOT_UMAIN_RW = 0x10C0D006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TOOL_R = 0x10F0D004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TOOL_RX = 0x10F0D005,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TOOL_RW = 0x10F0D006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TOOL_NC_R = 0x10F08004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TOOL_NC_RW = 0x10F08006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TMP_FS_GAME_R = 0x1220D004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TMP_FS_GAME_RW = 0x1220D006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TMP_FS_GAME_NC_R = 0x13208004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TMP_FS_GAME_NC_RW = 0x13208006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_IO_SO_R = 0x20100204,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_IO_SO_RW = 0x20100206,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_IO_R = 0x20100804,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_IO_RW = 0x20100806,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_IO_NC_R = 0x20108004,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_IO_NC_RW = 0x20108006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_CDRAM_L1WBWA_RW = 0x40404006,
    ...
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_TMP_GAME_RW = 0x6050D006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_KMP_GAME_RW = 0xC050D006,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_KMP_TOOL_RW = 0xC0F0D006,

    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_UNK_11208006_NC_RW = 0x11208006, // from ScePhyMemPartKD to SceKernelRootUncacheGpuGame
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_UNK_60208014_NC_R = 0x60208014,
    SCE_KERNEL_MEMBLOCK_TYPE_KERNEL_UNK_60208016_NC_RW = 0x60208016,

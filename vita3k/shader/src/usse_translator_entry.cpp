...
USSERecompiler::USSERecompiler(spv::Builder &b, const SceGxmProgram &program, const FeatureState &features, SpirvShaderParameters &parameters,
...
void convert_gxp_usse_to_spirv(spv::Builder &b, const SceGxmProgram &program, const FeatureState &features, SpirvShaderParameters &parameters, utils::SpirvUtilFunctions &utils,

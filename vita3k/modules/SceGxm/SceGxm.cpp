...
EXPORT(bool, sceGxmProgramParameterIsRegFormat, const SceGxmProgram *program, const SceGxmProgramParameter* parameter, uint32_t *param_2) {
    ...
    LOG_DEBUG("param3->field2:{}, value:{}, index:{}", param_2[3], log_hex(1 << (param_2[3] & 0x1f)), log_hex((param_2[3] >> 5) + 2));
    /*
    const uint32_t *VertexOutputs = program->VertexVaryings();

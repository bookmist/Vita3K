...
DECL_EXPORT(int, sceNetCtlAdhocDisconnect);
DECL_EXPORT(int, sceNetCtlAdhocGetInAddr, SceNetInAddr *inaddr);
DECL_EXPORT(int, sceNetCtlAdhocGetPeerList, SceSize *peerInfoNum, SceNetCtlAdhocPeerInfo *peerInfo);
DECL_EXPORT(int, sceNetCtlAdhocGetResult, int eventType, int *errorCode);
DECL_EXPORT(int, sceNetCtlAdhocGetState, int *state);
DECL_EXPORT(int, sceNetCtlAdhocRegisterCallback, Ptr<void> func, Ptr<void> arg, int *cid);
DECL_EXPORT(int, sceNetCtlAdhocUnregisterCallback, int cid);
DECL_EXPORT(int, sceNetCtlCheckCallback);
DECL_EXPORT(int, sceNetCtlGetIfStat, int device, SceNetCtlIfStat *ifstat);
DECL_EXPORT(int, sceNetCtlGetNatInfo, SceNetCtlNatInfo *natinfo);
DECL_EXPORT(int, sceNetCtlGetPhoneMaxDownloadableSize, SceInt64 *maxDownloadableSize);
DECL_EXPORT(int, sceNetCtlInetGetInfo, int code, SceNetCtlInfo *info);
DECL_EXPORT(int, sceNetCtlInetGetResult, int eventType, int *errorCode);
DECL_EXPORT(int, sceNetCtlInetGetState, int *state);
DECL_EXPORT(int, sceNetCtlInetRegisterCallback, Ptr<void> func, Ptr<void> arg, int *cid);
DECL_EXPORT(int, sceNetCtlInetUnregisterCallback, int cid);
DECL_EXPORT(int, sceNetCtlInit);
DECL_EXPORT(void, sceNetCtlTerm);

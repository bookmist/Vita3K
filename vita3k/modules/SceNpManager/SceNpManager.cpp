...
enum SceNpManagerErrorCode : uint32_t {
    ...
    SCE_NP_MANAGER_ERROR_INVALID_TICKET_SIZE = 0x80550505,
    SCE_NP_MANAGER_ERROR_INVALID_STATE = 0x80550506,
    SCE_NP_MANAGER_ERROR_ABORTED = 0x80550507,
    SCE_NP_MANAGER_ERROR_VARIANT_ACCOUNT_ID = 0x80550508,
    SCE_NP_MANAGER_ERROR_ID_NOT_AVAIL = 0x80550509,
    SCE_NP_MANAGER_ERROR_SIGNOUT = 0x8055050a,
    SCE_NP_MANAGER_ERROR_NEED_CALL_NETCHECK_DIALOG = 0x8055050b
};
